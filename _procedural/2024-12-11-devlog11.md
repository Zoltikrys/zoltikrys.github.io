...
This week, work was done to gamify the project. The first step in doing this was adding a controllable player, this was done using Unity's CharacterController class (Unity n.d).
WIP
