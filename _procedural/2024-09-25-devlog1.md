...
- 0: a side room that is not on the solution path (Kazemi, D. n.d.)

- 1: a room that is guarnteed to have a left exit and a right exit (Kazemi, D. n.d.)
...
- 3: a room that is guaranteed to have exits on the left, right, and top (Kazemi, D. n.d.)
...
Unity, n.d. *Random.Range (Unity API)*. [online] Available from: https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Random.Range.html
