---
title: "Devlog 6: Class Setup + Binary Space Partitioner"
subtitle: WIP
project-index: 95
...
---
The first step was to create the classes: DungeonCreator, DungeonGenerator, Node, RoomNode and Line.
...
The last step was to test the algorithm, after changing the parameters inside the Unity editor, a breakpoint was used in the DungeonGenerator class to make sure that the algorithm was working, as there was currently no visual implementation.![Uploading image.png…]()
